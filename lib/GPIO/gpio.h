...
// #include <SysClock.h> // Можно не использовать, если из ADC_init() убрать вызов ADC_calibrate()
//                       // и вызывать ADC_calibrate() в коде программы вручную после ADC_init().
#include <ch32v00x.h>
...
// // Delay functions
// // ===================================================================================
// #define DLY_ms(n) Sysclock.Delay_ms(n)
// #define DLY_us(n) Sysclock.Delay_us(n)
...
#define PIN_input(PIN) \
  ((PIN >= PA0) && (PIN <= PA7) ? (GPIOA->CFGLR = (GPIOA->CFGLR & ~((uint32_t)0b1111 << (((PIN) & 7) << 2))) | ((uint32_t)0b0100 << (((PIN) & 7) << 2))) : ((PIN >= PC0) && (PIN <= PC7) ? (GPIOC->CFGLR = (GPIOC->CFGLR & ~((uint32_t)0b1111 << (((PIN) & 7) << 2))) | ((uint32_t)0b0100 << (((PIN) & 7) << 2))) : ((PIN >= PD0) && (PIN <= PD7) ? (GPIOD->CFGLR = (GPIOD->CFGLR & ~((uint32_t)0b1111 << (((PIN) & 7) << 2))) | ((uint32_t)0b0100 << (((PIN) & 7) << 2))) : (0))))
...
#define PIN_input_PU(PIN) \
  ((PIN >= PA0) && (PIN <= PA7) ? ({GPIOA->CFGLR  =  (GPIOA->CFGLR                         \
                              ...
                              GPIOA->BSHR   =  ((uint32_t)1<<((PIN)&7)); }) : ((PIN >= PC0) && (PIN <= PC7) ? ({GPIOC->CFGLR  =  (GPIOC->CFGLR                         \
                                            & ~((uint32_t)0b1111<<(((PIN)&7)<<2)))   \
                                            |  ((uint32_t)0b1000<<(((PIN)&7)<<2));   \
                              GPIOC->BSHR   =  ((uint32_t)1<<((PIN)&7)); }) : ((PIN >= PD0) && (PIN <= PD7) ? ({GPIOD->CFGLR  =  (GPIOD->CFGLR                         \
                                            & ~((uint32_t)0b1111<<(((PIN)&7)<<2)))   \
                                            |  ((uint32_t)0b1000<<(((PIN)&7)<<2));   \
                              GPIOD->BSHR   =  ((uint32_t)1<<((PIN)&7)); }) : (0))))
...
#define PIN_input_PD(PIN) \
  ((PIN >= PA0) && (PIN <= PA7) ? ({GPIOA->CFGLR  =  (GPIOA->CFGLR                         \
                                            & ~((uint32_t)0b1111<<(((PIN)&7)<<2)))   \
                                            |  ((uint32_t)0b1000<<(((PIN)&7)<<2));   \
                              GPIOA->BCR    =  ((uint32_t)1<<((PIN)&7)); }) : ((PIN >= PC0) && (PIN <= PC7) ? ({GPIOC->CFGLR  =  (GPIOC->CFGLR                         \
                                            & ~((uint32_t)0b1111<<(((PIN)&7)<<2)))   \
                                            |  ((uint32_t)0b1000<<(((PIN)&7)<<2));   \
                              GPIOC->BCR    =  ((uint32_t)1<<((PIN)&7)); }) : ((PIN >= PD0) && (PIN <= PD7) ? ({GPIOD->CFGLR  =  (GPIOD->CFGLR                         \
                                            & ~((uint32_t)0b1111<<(((PIN)&7)<<2)))   \
                                            |  ((uint32_t)0b1000<<(((PIN)&7)<<2));   \
                              GPIOD->BCR    =  ((uint32_t)1<<((PIN)&7)); }) : (0))))

// ===================================================================================
// Set PIN as INPUT for analog peripherals (e.g. ADC)
// ===================================================================================
#define PIN_input_AN(PIN) \
  ((PIN >= PA0) && (PIN <= PA7) ? (GPIOA->CFGLR &= ~((uint32_t)0b1111 << (((PIN) & 7) << 2))) : ((PIN >= PC0) && (PIN <= PC7) ? (GPIOC->CFGLR &= ~((uint32_t)0b1111 << (((PIN) & 7) << 2))) : ((PIN >= PD0) && (PIN <= PD7) ? (GPIOD->CFGLR &= ~((uint32_t)0b1111 << (((PIN) & 7) << 2))) : (0))))
...
#define PIN_output(PIN) \
  ((PIN >= PA0) && (PIN <= PA7) ? (GPIOA->CFGLR = (GPIOA->CFGLR & ~((uint32_t)0b1111 << (((PIN) & 7) << 2))) | ((uint32_t)0b0001 << (((PIN) & 7) << 2))) : ((PIN >= PC0) && (PIN <= PC7) ? (GPIOC->CFGLR = (GPIOC->CFGLR & ~((uint32_t)0b1111 << (((PIN) & 7) << 2))) | ((uint32_t)0b0001 << (((PIN) & 7) << 2))) : ((PIN >= PD0) && (PIN <= PD7) ? (GPIOD->CFGLR = (GPIOD->CFGLR & ~((uint32_t)0b1111 << (((PIN) & 7) << 2))) | ((uint32_t)0b0001 << (((PIN) & 7) << 2))) : (0))))
...
#define PIN_output_OD(PIN) \
  ((PIN >= PA0) && (PIN <= PA7) ? (GPIOA->CFGLR = (GPIOA->CFGLR & ~((uint32_t)0b1111 << (((PIN) & 7) << 2))) | ((uint32_t)0b0101 << (((PIN) & 7) << 2))) : ((PIN >= PC0) && (PIN <= PC7) ? (GPIOC->CFGLR = (GPIOC->CFGLR & ~((uint32_t)0b1111 << (((PIN) & 7) << 2))) | ((uint32_t)0b0101 << (((PIN) & 7) << 2))) : ((PIN >= PD0) && (PIN <= PD7) ? (GPIOD->CFGLR = (GPIOD->CFGLR & ~((uint32_t)0b1111 << (((PIN) & 7) << 2))) | ((uint32_t)0b0101 << (((PIN) & 7) << 2))) : (0))))

// ===================================================================================
// Set PIN as alternate output (push-pull, maximum speed 10MHz)
// ===================================================================================
#define PIN_alternate(PIN) \
  ((PIN >= PA0) && (PIN <= PA7) ? (GPIOA->CFGLR = (GPIOA->CFGLR & ~((uint32_t)0b1111 << (((PIN) & 7) << 2))) | ((uint32_t)0b1001 << (((PIN) & 7) << 2))) : ((PIN >= PC0) && (PIN <= PC7) ? (GPIOC->CFGLR = (GPIOC->CFGLR & ~((uint32_t)0b1111 << (((PIN) & 7) << 2))) | ((uint32_t)0b1001 << (((PIN) & 7) << 2))) : ((PIN >= PD0) && (PIN <= PD7) ? (GPIOD->CFGLR = (GPIOD->CFGLR & ~((uint32_t)0b1111 << (((PIN) & 7) << 2))) | ((uint32_t)0b1001 << (((PIN) & 7) << 2))) : (0))))
...
#define PIN_alternate_OD(PIN) \
  ((PIN >= PA0) && (PIN <= PA7) ? (GPIOA->CFGLR = (GPIOA->CFGLR & ~((uint32_t)0b1111 << (((PIN) & 7) << 2))) | ((uint32_t)0b1101 << (((PIN) & 7) << 2))) : ((PIN >= PC0) && (PIN <= PC7) ? (GPIOC->CFGLR = (GPIOC->CFGLR & ~((uint32_t)0b1111 << (((PIN) & 7) << 2))) | ((uint32_t)0b1101 << (((PIN) & 7) << 2))) : ((PIN >= PD0) && (PIN <= PD7) ? (GPIOD->CFGLR = (GPIOD->CFGLR & ~((uint32_t)0b1111 << (((PIN) & 7) << 2))) | ((uint32_t)0b1101 << (((PIN) & 7) << 2))) : (0))))

// ===================================================================================
// Set PIN output value to LOW
// ===================================================================================
#define PIN_low(PIN) \
  ((PIN >= PA0) && (PIN <= PA7) ? (GPIOA->BCR = 1 << ((PIN) & 7)) : ((PIN >= PC0) && (PIN <= PC7) ? (GPIOC->BCR = 1 << ((PIN) & 7)) : ((PIN >= PD0) && (PIN <= PD7) ? (GPIOD->BCR = 1 << ((PIN) & 7)) : (0))))

// ===================================================================================
// Set PIN output value to HIGH
// ===================================================================================
#define PIN_high(PIN) \
  ((PIN >= PA0) && (PIN <= PA7) ? (GPIOA->BSHR = 1 << ((PIN) & 7)) : ((PIN >= PC0) && (PIN <= PC7) ? (GPIOC->BSHR = 1 << ((PIN) & 7)) : ((PIN >= PD0) && (PIN <= PD7) ? (GPIOD->BSHR = 1 << ((PIN) & 7)) : (0))))

// ===================================================================================
// Toggle PIN output value
// ===================================================================================
#define PIN_toggle(PIN) \
  ((PIN >= PA0) && (PIN <= PA7) ? (GPIOA->OUTDR ^= 1 << ((PIN) & 7)) : ((PIN >= PC0) && (PIN <= PC7) ? (GPIOC->OUTDR ^= 1 << ((PIN) & 7)) : ((PIN >= PD0) && (PIN <= PD7) ? (GPIOD->OUTDR ^= 1 << ((PIN) & 7)) : (0))))

// ===================================================================================
// Read PIN input value (returns 0 for LOW, 1 for HIGH)
// ===================================================================================
#define PIN_read(PIN) \
  ((PIN >= PA0) && (PIN <= PA7) ? ((GPIOA->INDR >> ((PIN) & 7)) & 1) : ((PIN >= PC0) && (PIN <= PC7) ? ((GPIOC->INDR >> ((PIN) & 7)) & 1) : ((PIN >= PD0) && (PIN <= PD7) ? ((GPIOD->INDR >> ((PIN) & 7)) & 1) : (0))))
...
#define PIN_INT_set(PIN, TYPE)                                                                                                      \
  {                                                                                                                                 \
    ((PIN >= PA0) && (PIN <= PA7) ? ({RCC->APB2PCENR |=  RCC_AFIOEN | RCC_IOPAEN;            \
                              AFIO->EXTICR   &= ~((uint32_t)3<<(((PIN)&7)<<1)); }) : ((PIN >= PC0) && (PIN <= PC7) ? ({RCC->APB2PCENR |=  RCC_AFIOEN | RCC_IOPCEN;            \
                              AFIO->EXTICR    =  (AFIO->EXTICR                       \
                                              & ~((uint32_t)3<<(((PIN)&7)<<1)))      \
                                              |  ((uint32_t)2<<(((PIN)&7)<<1)); }) : ((PIN >= PD0) && (PIN <= PD7) ? ({RCC->APB2PCENR |=  RCC_AFIOEN | RCC_IOPDEN;            \
                              AFIO->EXTICR   |=  ((uint32_t)3<<(((PIN)&7)<<1)); }) : (0)))); \
    (TYPE & 3) ? (EXTI->INTENR |= (uint32_t)1 << ((PIN) & 7)) : (EXTI->INTENR &= ~((uint32_t)1 << ((PIN) & 7)));                    \
    (TYPE & 1) ? (EXTI->RTENR |= (uint32_t)1 << ((PIN) & 7)) : (EXTI->RTENR &= ~((uint32_t)1 << ((PIN) & 7)));                      \
    (TYPE & 2) ? (EXTI->FTENR |= (uint32_t)1 << ((PIN) & 7)) : (EXTI->FTENR &= ~((uint32_t)1 << ((PIN) & 7)));                      \
  }
  ...
  {                                                                                                                                 \
    ((PIN >= PA0) && (PIN <= PA7) ? ({RCC->APB2PCENR |=  RCC_AFIOEN | RCC_IOPAEN;            \
                              ...
                              AFIO->EXTICR    =  (AFIO->EXTICR                       \
                                              ...
                                              |  ((uint32_t)2<<(((PIN)&7)<<1)); }) : ((PIN >= PD0) && (PIN <= PD7) ? ({RCC->APB2PCENR |=  RCC_AFIOEN | RCC_IOPDEN;            \
                              AFIO->EXTICR   |=  ((uint32_t)3<<(((PIN)&7)<<1)); }) : (0)))); \
    (TYPE & 3) ? (EXTI->EVENR |= (uint32_t)1 << ((PIN) & 7)) : (EXTI->EVENR &= ~((uint32_t)1 << ((PIN) & 7)));                      \
    (TYPE & 1) ? (EXTI->RTENR |= (uint32_t)1 << ((PIN) & 7)) : (EXTI->RTENR &= ~((uint32_t)1 << ((PIN) & 7)));                      \
    (TYPE & 2) ? (EXTI->FTENR |= (uint32_t)1 << ((PIN) & 7)) : (EXTI->FTENR &= ~((uint32_t)1 << ((PIN) & 7)));                      \
  }
...
#define PORT_enable(PIN) \
  ((PIN >= PA0) && (PIN <= PA7) ? (RCC->APB2PCENR |= RCC_IOPAEN) : ((PIN >= PC0) && (PIN <= PC7) ? (RCC->APB2PCENR |= RCC_IOPCEN) : ((PIN >= PD0) && (PIN <= PD7) ? (RCC->APB2PCENR |= RCC_IOPDEN) : (0))))
...
#define ADC_input(PIN) \
  (PIN == PA1 ? (ADC1->RSQR3 = 1) : (PIN == PA2 ? (ADC1->RSQR3 = 0) : (PIN == PC4 ? (ADC1->RSQR3 = 2) : (PIN == PD2 ? (ADC1->RSQR3 = 3) : (PIN == PD3 ? (ADC1->RSQR3 = 4) : (PIN == PD4 ? (ADC1->RSQR3 = 7) : (PIN == PD5 ? (ADC1->RSQR3 = 5) : (PIN == PD6 ? (ADC1->RSQR3 = 6) : (0)))))))))
...
// initialize ADC. Не забывать вызывать ADC_calibrate() после ADC_init().
...
#define OPA_negative(PIN) \
  (PIN == PA1 ? (EXTEN->EXTEN_CTR &= ~EXTEN_OPA_NSEL) : (PIN == PD0 ? (EXTEN->EXTEN_CTR |= EXTEN_OPA_NSEL) : (0)))

#define OPA_positive(PIN) \
  (PIN == PA2 ? (EXTEN->EXTEN_CTR &= ~EXTEN_OPA_PSEL) : (PIN == PD7 ? (EXTEN->EXTEN_CTR |= EXTEN_OPA_PSEL) : (0)))

#define OPA_output()                                                                                  \
  {                                                                                                   \
    RCC->APB2PCENR |= RCC_AFIOEN;                                                                     \
    GPIOD->CFGLR = (GPIOD->CFGLR & ~((uint32_t)0b1111 << (4 << 2))) | ((uint32_t)0b1001 << (4 << 2)); \
  }

#define OPA_output_OD()                                                                               \
  {                                                                                                   \
    RCC->APB2PCENR |= RCC_AFIOEN;                                                                     \
    GPIOD->CFGLR = (GPIOD->CFGLR & ~((uint32_t)0b1111 << (4 << 2))) | ((uint32_t)0b1101 << (4 << 2)); \
  }
